...
public class PoseEstimatorSubsystem extends SubsystemBase {
     ...
     * PoseEstimatorSubsystem#update} every loop.
     *
    ...
    public void addVisionMeasurement(Pose2d visionRobotPoseMeters, double timestampSeconds) {
        ...
        m_poseBuffer.addSample(
                timestampSeconds,
                new PoseEstimatorSubsystem.InterpolationRecord(
        ...
        for (Map.Entry<Double, PoseEstimatorSubsystem.InterpolationRecord> entry :
    ...
    public Pose2d updateWithTime(
        ...
        m_poseBuffer.addSample(
                currentTimeSeconds,
                new PoseEstimatorSubsystem.InterpolationRecord(getEstimatedPosition(), gyroAngle, internalModulePositions));
     ...
     */
    private class InterpolationRecord implements Interpolatable<PoseEstimatorSubsystem.InterpolationRecord> {
         ...
         */
        @Override
        public PoseEstimatorSubsystem.InterpolationRecord interpolate(PoseEstimatorSubsystem.InterpolationRecord endValue, double t) {
            if (t < 0) {
                return this;
            } else if (t >= 1) {
                return endValue;
                ...
                return new PoseEstimatorSubsystem.InterpolationRecord(poseMeters.exp(twist), gyro_lerp, modulePositions);
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof PoseEstimatorSubsystem.InterpolationRecord)) {
                return false;
            }
            PoseEstimatorSubsystem.InterpolationRecord record = (PoseEstimatorSubsystem.InterpolationRecord) obj;
